...
class MainLessons extends StatefulWidget {
  const MainLessons({super.key});

  // This widget is the root of your application.
  @override
  State<MainLessons> createState()=> MyMainLessons();
}
class MyMainLessons extends State<MainLessons>  {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("المنهاج", style: TextStyle(color: Colors.white),),
