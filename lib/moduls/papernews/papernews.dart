...
class PaperNews extends StatefulWidget {
  const PaperNews({super.key});

  // This widget is the root of your application.
  @override
  State<PaperNews> createState()=> NewsPaperState();
}

class NewsPaperState extends State<PaperNews> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("أخبار المدرسة", style: TextStyle(color: Colors.white),),
